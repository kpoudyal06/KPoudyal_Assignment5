...
public class MorseCodeConverterTestPublic {
	...
	public void testConvertMorseStringToEnglishString() {	
		...
		assertEquals("my name is ali", converter2);
	...
	public void testConvertMorseFileToEnglishString() {	
		...
		*/
		...
		File file2 = new File("src/StudentTextTest.txt");
		try {
			assertEquals("how do i love thee let me count the ways", MorseCodeConverter.convertToEnglish(file1));
			assertEquals("good morning vietnam", MorseCodeConverter.convertToEnglish(file2));
